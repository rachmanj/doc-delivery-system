...
<head>
    ...
    <title>Register | Document Delivery System</title>
        ...
        <div class="card">
            <div class="card-body register-card-body">
                ...
                <form method="POST" action="{{ route('register') }}">
                    ...
                    <div class="input-group mb-3">
                        <input id="project" type="text" class="form-control @error('project') is-invalid @enderror"
                            name="project" value="{{ old('project') }}" placeholder="Project">
                        <div class="input-group-append">
                            <div class="input-group-text">
