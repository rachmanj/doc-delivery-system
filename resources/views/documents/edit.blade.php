            ...
            <div class="col-12">
                <div class="card">
                    <div class="card-header">
                        ...
                        <a href="{{ route('documents.index') }}" class="btn btn-default btn-sm float-right">
                            ...
                            <div class="row">
                                <div class="col-md-6">
                                    <div class="form-group">
                                        ...
                                        <select class="form-control select2bs4 @error('invoice_id') is-invalid @enderror"
                                ...
                                <div class="col-md-6">
                                    <div class="form-group">
                                        ...
                                        <input type="date"
                                            ...
                                            value="{{ old('receive_date', $document->receive_date ? \Carbon\Carbon::parse($document->receive_date)->format('Y-m-d') : '') }}">
                                        @error('receive_date')
                                            <span class="invalid-feedback">{{ $message }}</span>
                                        @enderror
                                    </div>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <select class="form-control select2bs4 @error('cur_loc') is-invalid @enderror"
                                            ...
                                            <option value="" disabled
                                                {{ old('cur_loc', $document->cur_loc) === null ? 'selected' : '' }}>Select
                                                Location</option>
